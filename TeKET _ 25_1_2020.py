...
full_path = [os.path.join(r,file) for r,d,f in os.walk("Train data") for file in f]
for i in range(0,len(full_path),1):
    ...
    with open(full_path[i], "r",encoding="utf-8") as f:
        ...
        treemanager.ProcessCandidatePhrase (NounTF_tuple, candidate_phrases_count_lsaf, mu, final_node_list)
        Keyphrases = treemanager.ReturnKeyPhrases (final_node_list, candidate_phrases_count_lsaf,text)                
